  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        formData.append("temperatureRange[min]", values.temperatureRangeMin);
        formData.append("temperatureRange[max]", values.temperatureRangeMax);
      ...
      <div className={styles.formContainer}>
        <div className={styles.formRow}>
          ...
          <div className={styles.formGroup}>
            ...
            <input type="text" {...formik.getFieldProps("scientificName")} />
        ...
        <div className={styles.formRow}>
          ...
          <div className={styles.formGroup}>
            <label>Origin</label>
            <input type="text" {...formik.getFieldProps("origin")} />
        ...
        <div className={styles.formRow}>
          <div className={styles.formGroup}>
            ...
            <select {...formik.getFieldProps("wateringFrequency")}>
          ...
          <div className={styles.formGroup}>
            ...
            <select {...formik.getFieldProps("soilType")}>
        ...
        <div className={styles.formRow}>
          <div className={styles.formGroup}>
            ...
            />
            {formik.touched.temperatureRangeMax &&
              formik.errors.temperatureRangeMax && (
                <div className={styles.error}>
                  {formik.errors.temperatureRangeMax}
                </div>
              )}
          ...
          <div className={styles.formGroup}>
            ...
            />
            {formik.touched.temperatureRangeMin &&
              formik.errors.temperatureRangeMin && (
                <div className={styles.error}>
                  {formik.errors.temperatureRangeMin}
                </div>
              )}
